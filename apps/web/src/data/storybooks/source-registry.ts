...
export const STORYBOOK_SOURCE_REGISTRY: readonly StorybookSourceRecord[] = [
  ...
  {
    contentId: "castle-lesson-03",
    originalFileName: "第3课时绘本无拼音.docx",
    documentSha256: "B6A951F9D4EBAB79F5F1482615364C83CFBA77DB8E4EDCE5B8D6D04392F67604",
    pageCount: 10,
    imageCount: 10,
    status: "ready",
  },
  {
    contentId: "technology-lesson-01",
  ...
  {
    contentId: "technology-lesson-02",
  ...
  {
    contentId: "technology-lesson-03",
